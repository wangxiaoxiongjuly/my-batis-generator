...
import config.content.DataBaseType;
...
public class PagingPlugin extends PluginAdapter {
    ...
    public boolean sqlMapSelectByExampleWithoutBLOBsElementGenerated(XmlElement element, IntrospectedTable introspectedTable) {
        ...
        if (DataBaseType.MYSQL.equals(dataType)) {
            appendPageInfoAfterSelectByExampleXml(element);
            return super.sqlMapSelectByExampleWithoutBLOBsElementGenerated(element, introspectedTable);
        } else {
            return oraSqlMapSelectByExampleWithoutBLOBsElementGenerated(element, introspectedTable);
        }
    }

    private boolean oraSqlMapSelectByExampleWithoutBLOBsElementGenerated(XmlElement element, IntrospectedTable introspectedTable) {
    ...
    public boolean modelExampleClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        if (DataBaseType.MYSQL.equals(dataType)) {
            ...
            return oraModelExampleClassGenerated(topLevelClass, introspectedTable);
        }
    }

    private boolean oraModelExampleClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        // add field, getter, setter for page info
        addOraPageInfoToExampleClass(topLevelClass, introspectedTable);
        return super.modelExampleClassGenerated(topLevelClass, introspectedTable);
    }

    private void addOraPageInfoToExampleClass(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        oraUpdateSchema(topLevelClass);
    ...
    private void oraUpdateSchema(TopLevelClass topLevelClass) {
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        String dataType = PropertiesUtil.getProperty("dataBaseType", "mysql");
        if (DataBaseType.ORACLE.equals(dataType)) {
